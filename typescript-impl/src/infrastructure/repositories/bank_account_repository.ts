...
export interface BankAccountRepository {
    ...
    update(bank_account_id: number, first_name: string, last_name: string, date_of_birth: Date, email: string, national_id: string, phone_number: string, parmanent_address: string): boolean;
